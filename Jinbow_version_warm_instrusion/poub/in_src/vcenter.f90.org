...
!                                                                       
      ...
      !         if (u(i,j,k,n) /= 0) then
      !            print*, "u",u(i,j,k,n)
      !            print*, "U nonzero at i" ,i,'j',j,'k',k
...
contains
      ...
      subroutine error(n)
      integer :: n
      print*, "vcenter.f90, max(w)",maxval(w),'at ln',n
      print*, "vcenter.f90, max(u)",maxval(u),'at ln',n
      print*, "vcenter.f90, max(v)",maxval(v),'at ln',n
      end subroutine error
      
      END subroutine vcenter                                           
